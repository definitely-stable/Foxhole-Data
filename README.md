...
Status: **M1 repository bootstrap implemented**. Official War API ingestion begins in M3; the current runtime intentionally performs no upstream Foxhole requests.
