...
namespace FoxData.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260926091250_M5CanonicalWarRegionReport")]
    partial class M5CanonicalWarRegionReport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.NormalizationRunRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("SourceParseRunId")
                        .HasColumnType("uuid")
                        .HasColumnName("source_parse_run_id");
                    ...
                    b.HasIndex("SourceParseRunId", "NormalizerVersion")
                        .IsUnique()
                        .HasDatabaseName("ux_normalization_runs_parse_normalizer");

                    b.ToTable("normalization_runs", "evidence", t =>
                        {
                            t.HasCheckConstraint("ck_normalization_runs_completed_after_started", "completed_at >= started_at");

                            t.HasCheckConstraint("ck_normalization_runs_outcome", "outcome IN ('normalized','rejected','failed')");
                        });
                });
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.RegionRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarObservationRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<DateTimeOffset?>("ConquestEndTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("conquest_end_time");

                    b.Property<DateTimeOffset?>("ConquestStartTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("conquest_start_time");

                    b.Property<Guid>("NormalizationRunId")
                        .HasColumnType("uuid")
                        .HasColumnName("normalization_run_id");
                    ...
                    b.Property<int?>("RequiredVictoryTowns")
                        .HasColumnType("integer")
                        .HasColumnName("required_victory_towns");

                    b.Property<DateTimeOffset?>("ResistanceStartTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("resistance_start_time");

                    b.Property<DateTimeOffset?>("ScheduledConquestEndTime")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("scheduled_conquest_end_time");

                    b.Property<int?>("ShortRequiredVictoryTowns")
                        .HasColumnType("integer")
                        .HasColumnName("short_required_victory_towns");
                    ...
                    b.HasIndex("WarId", "ObservedAt", "Id")
                        .HasDatabaseName("ix_war_observations_war_observed");

                    b.ToTable("war_observations", "runtime", t =>
                        {
                            t.HasCheckConstraint("ck_war_observations_required_victory_towns", "required_victory_towns IS NULL OR required_victory_towns >= 0");

                            t.HasCheckConstraint("ck_war_observations_short_required_victory_towns", "short_required_victory_towns IS NULL OR short_required_victory_towns >= 0");
                        });
                });

            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarRegionRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("SourceMapName")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                    ...
                    b.HasIndex("WarId", "RegionId")
                        .HasDatabaseName("ix_war_regions_war_region");

                    b.HasIndex("WarId", "SourceMapName")
                        .IsUnique()
                        .HasDatabaseName("ux_war_regions_war_source_map");

                    b.ToTable("war_regions", "runtime", t =>
                        {
                            t.HasCheckConstraint("ck_war_regions_observation_window", "last_seen_at >= first_seen_at");
                        });
                });

            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarReportObservationRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");

                    b.Property<long?>("ColonialCasualties")
                        .HasColumnType("bigint")
                        .HasColumnName("colonial_casualties");

                    b.Property<int?>("DayOfWar")
                        .HasColumnType("integer")
                        .HasColumnName("day_of_war");
                    ...
                    b.Property<long?>("TotalEnlistments")
                        .HasColumnType("bigint")
                        .HasColumnName("total_enlistments");

                    b.Property<Guid>("WarRegionId")
                        .HasColumnType("uuid")
                        .HasColumnName("war_region_id");

                    b.Property<long?>("WardenCasualties")
                        .HasColumnType("bigint")
                        .HasColumnName("warden_casualties");
                    ...
                    b.HasIndex("WarRegionId", "ObservedAt", "Id")
                        .HasDatabaseName("ix_war_report_observations_region_observed");

                    b.ToTable("war_report_observations", "runtime", t =>
                        {
                            t.HasCheckConstraint("ck_war_report_observations_colonial_casualties", "colonial_casualties IS NULL OR colonial_casualties >= 0");

                            t.HasCheckConstraint("ck_war_report_observations_day_of_war", "day_of_war IS NULL OR day_of_war >= 0");

                            t.HasCheckConstraint("ck_war_report_observations_total_enlistments", "total_enlistments IS NULL OR total_enlistments >= 0");

                            t.HasCheckConstraint("ck_war_report_observations_warden_casualties", "warden_casualties IS NULL OR warden_casualties >= 0");
                        });
                });

            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("ShardId", "SourceWarId")
                        .IsUnique()
                        .HasDatabaseName("ux_wars_shard_source_war");

                    b.HasIndex("ShardId", "WarNumber")
                        .HasDatabaseName("ix_wars_shard_war_number");

                    b.ToTable("wars", "runtime", t =>
                        {
                            t.HasCheckConstraint("ck_wars_observation_window", "last_observed_at >= first_observed_at");
                        });
                });
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.NormalizationRunRow", b =>
                {
                    b.HasOne("FoxData.Infrastructure.Persistence.SourceParseRunRow", null)
                        .WithMany()
                        .HasForeignKey("SourceParseRunId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarObservationRow", b =>
                {
                    b.HasOne("FoxData.Infrastructure.Persistence.NormalizationRunRow", null)
                        .WithMany()
                        .HasForeignKey("NormalizationRunId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("FoxData.Infrastructure.Persistence.WarRow", null)
                        .WithMany()
                        .HasForeignKey("WarId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarRegionRow", b =>
                {
                    b.HasOne("FoxData.Infrastructure.Persistence.RegionRow", null)
                        .WithMany()
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.WarReportObservationRow", b =>
                {
                    ...
                    b.HasOne("FoxData.Infrastructure.Persistence.WarRegionRow", null)
                        .WithMany()
                        .HasForeignKey("WarRegionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
