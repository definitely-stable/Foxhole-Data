...
namespace FoxData.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920113327_M2EvidenceKernelInitial")]
    partial class M2EvidenceKernelInitial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.EndpointStateRow", b =>
                {
                    ...
                    b.Property<Guid?>("LastAuthoritativeAttemptId")
                        .HasColumnType("uuid")
                        .HasColumnName("last_authoritative_attempt_id");
                    ...
                    b.HasIndex("LastAuthoritativeAttemptId");
            ...
            modelBuilder.Entity("FoxData.Infrastructure.Persistence.EndpointStateRow", b =>
                {
                    ...
                    b.HasOne("FoxData.Infrastructure.Persistence.IngestionAttemptRow", null)
                        .WithMany()
                        .HasForeignKey("LastAuthoritativeAttemptId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
